...
#ifndef XLA_PJRT_EXTENSIONS_CALLBACK_CALLBACK_EXTENSION_H_
#define XLA_PJRT_EXTENSIONS_CALLBACK_CALLBACK_EXTENSION_H_
...
enum PJRT_Callback_Type {
  ...
  PJRT_Callback_Type_SliceBuilder,
...
#ifdef __cplusplus
enum class SliceFailureType : int32_t {
#else
enum SliceFailureType : int32_t {
#endif
...
struct PJRT_Callback_SliceBuilderArgs {
  size_t struct_size;
  SliceFailureType failure_type;
};
PJRT_DEFINE_STRUCT_TRAITS(PJRT_Callback_SliceBuilderArgs, failure_type);
...
#endif  // XLA_PJRT_EXTENSIONS_CALLBACK_CALLBACK_EXTENSION_H_
